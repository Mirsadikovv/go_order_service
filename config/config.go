...
func Load() Config {
	...
	config.ServiceName = cast.ToString(getOrReturnDefaultValue("SERVICE_NAME", "go_order_service"))
	...
	config.OrderServicePort = cast.ToInt(getOrReturnDefaultValue("ORDER_SERVICE_PORT", 8082))
